...
export type CreateGathering = {
    ...
    skill_level_max?: GatheringSkillLevel | null;
...
export type EmailSignUpPending = {
    email: string;
    email_sent: boolean;
...
export type PostApiAuthSignInEmailResponse = PostApiAuthSignInEmailResponses[keyof PostApiAuthSignInEmailResponses];

export type PostApiAuthVerificationResendData = {
...
export type PostApiAuthVerificationResendErrors = {
    400: ErrorBody;
    401: ErrorBody;
    403: ErrorBody;
    404: ErrorBody;
...
export type PostApiAuthVerificationResendError = PostApiAuthVerificationResendErrors[keyof PostApiAuthVerificationResendErrors];

export type PostApiAuthVerificationResendResponses = {
    200: StatusResponse;
};

export type PostApiAuthVerificationResendResponse = PostApiAuthVerificationResendResponses[keyof PostApiAuthVerificationResendResponses];
...
export type PostApiAuthSignOutError = PostApiAuthSignOutErrors[keyof PostApiAuthSignOutErrors];
...
export type PostApiAuthOauthGoogleStartErrors = {
    400: ErrorBody;
    401: ErrorBody;
    403: ErrorBody;
    404: ErrorBody;
...
export type PostApiAuthOauthGoogleStartError = PostApiAuthOauthGoogleStartErrors[keyof PostApiAuthOauthGoogleStartErrors];

export type PostApiAuthOauthGoogleStartResponses = {
    200: GoogleOAuthStartResponse;
};
...
export type PostApiAuthOauthExchangeErrors = {
    400: ErrorBody;
    401: ErrorBody;
    403: ErrorBody;
    404: ErrorBody;
...
export type PostApiAuthOauthExchangeError = PostApiAuthOauthExchangeErrors[keyof PostApiAuthOauthExchangeErrors];

export type PostApiAuthOauthExchangeResponses = {
    200: AuthenticatedSession;
};

export type PostApiAuthOauthExchangeResponse = PostApiAuthOauthExchangeResponses[keyof PostApiAuthOauthExchangeResponses];
