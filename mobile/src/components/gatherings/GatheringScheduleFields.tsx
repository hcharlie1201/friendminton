...
const styles = StyleSheet.create({
  ...
  timelineDot: { backgroundColor: colors.surface, borderColor: colors.primary, borderRadius: 6, borderWidth: 2, height: 12, left: 0, position: 'absolute', width: 12 },
  startDot: { top: 7 },
  endDot: { bottom: 7 },
  ...
  rowLabel: { color: colors.text, fontFamily: fonts.black, fontSize: 13, fontWeight: '900' },
  valueGroup: { flex: 1, flexDirection: 'row', gap: 6, justifyContent: 'flex-end' },
  valueButton: { backgroundColor: colors.primarySurface, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 9 },
  valueText: { color: colors.primaryStrong, fontFamily: fonts.bold, fontSize: 12, fontWeight: '700' },
  pickerPanel: { backgroundColor: colors.primarySurface, borderRadius: 16, padding: 10 },
